...
def initialize_db (mes, main_dir):
    ...
    cur.execute("CREATE TABLE IF NOT EXISTS `unyohub_data`(`operation_date` TEXT NOT NULL, `operation_number` TEXT NOT NULL, `user_id` TEXT NOT NULL, `formations` TEXT NOT NULL, `is_quotation` INTEGER, `posted_datetime` TEXT NOT NULL, `comment` TEXT, `ip_address` TEXT, PRIMARY KEY(`operation_date`, `operation_number`, `user_id`))")
    ...
    mes("テーブル「unyohub_transition_statistics_same_day」を作成しています...")
    ...
    mes("テーブル「unyohub_transition_statistics_to_next_day」を作成しています...")
