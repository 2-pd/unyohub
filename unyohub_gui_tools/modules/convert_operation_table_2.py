...
def convert_operation_table_2 (mes, main_dir, file_name):
    ...
    while cnt < len(operation_data):
        if operation_data[cnt][0].startswith("# "):
            operation_groups.append({"operation_group_name" : operation_data[cnt][0][2:].strip(), "operation_numbers": []})
            ...
            car_count = operation_data[cnt + 1][0]
