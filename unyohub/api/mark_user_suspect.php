...
$moderation_db_obj->query("INSERT INTO `unyohub_moderation_suspicious_users` (`user_id`, `moderator_id`, `marked_datetime`) VALUES ('".$moderation_db_obj->escapeString($_POST["user_id"])."', '".$user->get_id()."', '".date("Y-m-d H:i:s")."')");
