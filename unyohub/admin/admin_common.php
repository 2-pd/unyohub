...
if (empty($config)) {
    $config = array("instance_name" => "鉄道運用Hub");
}
...
function print_header () {
    ...
    <body>
        <header onclick="location.href = 'index.php';"><div id="railroad_icon"></div>{$instance_name} 管理画面<button type="button" id="control_panel_close_button" onclick="event.stopPropagation(); window.close();"></button></header>
    EOM;
}
