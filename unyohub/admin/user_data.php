...
print "<div class='key_and_value'><b>状態</b><span style='color: ".($user_obj->get_status() === WAKARANA_STATUS_NORMAL ? "#33cc99;'>有効" : "#ee3333;'>停止中")."</span></div>";
...
print "<div class='key_and_value'><b>現在の状態</b>".(empty($time_out_expiration) ? "タイムアウトなし" : "<span style='color: #ee7700;'>タイムアウト中 (残 ".(ceil((strtotime($time_out_expiration) - $now_ts) / 86400))."日)</span>")."</div>";
