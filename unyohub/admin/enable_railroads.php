...
print "<form action='enable_railroads.php' method='post' id='enable_form' style='display: none;'>";
print $token_html;
print "<input type='hidden' name='enabling_railroad' id='enabling_railroad'>";
print "</form>";

print "<form action='enable_railroads.php' method='post' id='disable_form' style='display: none;'>";
print $token_html;
