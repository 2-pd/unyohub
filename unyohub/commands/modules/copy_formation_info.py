...
def copy_formation_info (mes, source_main_dir, source_formation_name, target_main_dir, target_formation_name=None):
    ...
    cur.execute("SELECT `series_name`, `subseries_name`, `car_count`, `affiliation`, `caption`, `description`, `unavailable`, `inspection_information` FROM `unyohub_formations` WHERE `formation_name` = :formation_name", {"formation_name" : source_formation_name})
    ...
    cur.execute("INSERT INTO `unyohub_formations`(`formation_name`, `series_name`, `subseries_name`, `car_count`, `affiliation`, `caption`, `description`, `semifixed_formation`, `unavailable`, `inspection_information`, `overview_updated`, `updated_datetime`, `edited_user_id`) VALUES (:formation_name, :series_name, :subseries_name, :car_count, :affiliation, :caption, :description, NULL, :unavailable, :inspection_information, :overview_updated, :updated_datetime, NULL) ON CONFLICT (`formation_name`) DO UPDATE SET `affiliation` = :affiliation_2, `caption` = :caption_2, `description` = :description_2, `unavailable` = :unavailable_2, `inspection_information` = :inspection_information_2, `overview_updated` = :overview_updated_2, `updated_datetime` = :updated_datetime_2, `edited_user_id` = NULL", {"formation_name" : target_formation_name, "series_name" : formation_data[0], "subseries_name" : formation_data[1], "car_count" : formation_data[2], "affiliation" : formation_data[3], "caption" : formation_data[4], "description" : formation_data[5], "unavailable" : formation_data[6], "inspection_information" : formation_data[7], "overview_updated" : datetime_now, "updated_datetime" : datetime_now, "affiliation_2" : formation_data[3], "caption_2" : formation_data[4], "description_2" : formation_data[5], "unavailable_2" : formation_data[6], "inspection_information_2" : formation_data[7], "overview_updated_2" : datetime_now, "updated_datetime_2" : datetime_now})
