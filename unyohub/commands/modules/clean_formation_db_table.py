...
def clean_formation_db_table (mes, main_dir):
    ...
    for formation_name in excluded_formations:
        ...
        cur.execute("DELETE FROM `unyohub_car_histories` WHERE `formation_name` = :formation_name", {"formation_name" : formation_name})
    ...
    for formation_name in formation_list:
        ...
        for car_number in excluded_cars:
            ...
            cur.execute("DELETE FROM `unyohub_car_histories` WHERE `formation_name` = :formation_name AND `car_number` = :car_number", {"formation_name" : formation_name, "car_number" : car_number})
